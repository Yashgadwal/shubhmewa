...
export const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  hero_subtitle: "ShubhMewa brings carefully selected dry fruits, makhana, seeds, and aromatic spices directly to your doorstep.",
